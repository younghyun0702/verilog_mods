...
module fnd_controller #(
    ...
    input rst,
    // input [13:0] fnd_in,
    input [13:0] fnd_in_hum,
    input [13:0] fnd_in_temp,
    output [3:0] fnd_com,
    output [7:0] fnd_data
);
    ...
    mux_4x1 U_MUX_4X1 (
        .in0(w_hum_digit_1),  // humidity digit 1
        .in1(w_hum_digit_10),  // humidity digit 10
        .in2(w_temp_digit_1),  // temperature digit 1
        .in3(w_temp_digit_10),  // temperature digit 10
