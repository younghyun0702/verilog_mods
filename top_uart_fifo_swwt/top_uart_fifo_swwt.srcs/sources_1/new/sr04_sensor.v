...
module top_sr04_controller (
    ...
    wire w_tick_58us;
    wire [8:0] w_distance;
    wire [3:0] w_sr04_bcd_1, w_sr04_bcd_10, w_sr04_bcd_100;

    assign distance = w_distance;
    assign sr04_bcd = {w_sr04_bcd_100, w_sr04_bcd_10, w_sr04_bcd_1};


    sr04_bcd U_SR04_BCD (
        .distance_in (w_distance),
        .distance_1  (w_sr04_bcd_1),
        .distance_10 (w_sr04_bcd_10),
        .distance_100(w_sr04_bcd_100)
    );
